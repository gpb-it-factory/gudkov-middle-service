...
public class CurrentBalanceBackendResponseHandler {
    ...
    /**
     * Method that trying to map backend response to AccountListResponseV2Inner entities array.
     * @param incomingData - backend response to getUserAccountsV2 call
     * @return new ResponseEntity with Accounts array and backendResponse HttpStatus code.
     */
