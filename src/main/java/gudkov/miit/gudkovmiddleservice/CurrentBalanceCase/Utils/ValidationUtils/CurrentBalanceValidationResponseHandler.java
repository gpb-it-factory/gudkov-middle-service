package gudkov.miit.gudkovmiddleservice.CurrentBalanceCase.Utils.ValidationUtils;
 ...
 */
@Component
public class CurrentBalanceValidationResponseHandler {
    private static final Logger log = LoggerFactory.getLogger(CurrentBalanceValidationResponseHandler.class);
